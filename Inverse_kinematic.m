...
EC = CD + DE;
AE = sqrt(x^2+y^2);
angle_ECA = (acos((EC^2+AC^2-AE^2)/2/EC/AC));
angle_CAE = (acos((AC^2+AE^2-EC^2)/2/AC/AE));
...
deltaX = -(Hx - H_0x);
q0 = 26/16*deltaX /2.5*2*pi;%X电机

vector_AE = [x y];
vector_CE = EC/AG*vector_AG;
