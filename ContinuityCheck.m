...
%产生变量
ee_pos_in_world = readmatrix('eeTraj.txt');
mot_input = readmatrix('Invinput.txt');
...
ddif_x1=dif_x1(2:end)-dif_x1(1:end-1);
...
%二次差分
ddif_m1=dif_m1(2:end)-dif_m1(1:end-1);
